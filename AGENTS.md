...
1. **Create the material.**
   ...
   - If the page title (title plus the grade, see "SEO rules") passes 60 characters, add `seoTitle` (`ro` + `en`, main topic words first) to the material by hand, then run `node tools/build_pages.mjs` and `python tools/pdf_meta.py <uid>`.
